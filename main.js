...
const clearSearchTodos = document.querySelector("#clear-search-todos");
  ...
  todosToRender.forEach((todo, i) => {
    output.innerHTML += `
            ...
            <div class="todo ${todo.done && "done"}">
                ...
                <button id="${todo.id}" class="delete-todo" title="Delete todo">X</button>
            </div>
        `;
  });
